...
# job('FURIXON')
# job('유비플러스')
schedule_weekday.every().day.at('17:40').do(job, 'FURIXON')
schedule_weekday.every().day.at('17:45').do(job, '유비플러스')
...
schedule_weekday.every().day.at('19:50').do(job, 'FURIXON')
schedule_weekday.every().day.at('19:55').do(job, '유비플러스')
...
schedule_weekend.every().day.at('16:50').do(job, 'FURIXON')
schedule_weekend.every().day.at('16:55').do(job, '유비플러스')
